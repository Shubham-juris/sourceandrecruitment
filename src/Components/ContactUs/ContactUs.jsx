  ...
  return (
    ...
    >
      ...
      <Grid container spacing={4} sx={{ justifyContent: "center", mt: 4 }}>
        {[ 
          { icon: <LocationOnIcon fontSize="large" sx={{ color: "#007bff" }} />, title: "Our Campus", content: "123" },
          { icon: <PhoneIcon fontSize="large" sx={{ color: "#007bff" }} />, title: "Phone", content: "+1 123-456-7890" },
